...
def test_project_str_method():
    ...
    assert str(project) == "Project Name 1"
...
def test_add_stakeholder_to_project():
    ...
    assert project.stakeholder.count() == 2
...
def test_add_team_member_to_project():
    ...
    assert project.team_member.count() == 2
...
def test_project_unique_name_constraint():
    ...
    with pytest.raises(Exception):
        project2 = Project.objects.create(name="Test Project 1")
